          ...
          <div className="max-w-sm md:max-w-7xl mx-auto">
            ...
            <div className="flex flex-wrap">
              <div className="w-full md:w-1/2 lg:w-1/3">
                <div className="pt-10 px-6 xs:px-10 pb-14 bg-gray-800/60 rounded-t-xl md:rounded-none md:rounded-tl-xl">
              ...
              <div className="w-full md:w-1/2 lg:w-1/3">
                <div className="pt-10 px-6 xs:px-10 pb-14 bg-gray-800/60 md:bg-transparent lg:bg-gray-800/60 rounded-xl md:rounded-none lg:rounded-tr-xl">
                  <div className="flex items-center justify-between mb-8 pb-8 border-b border-gray-700">
                    <div>
                      <span className="block text-base font-semibold text-white">
                        Scott Douglas Clary
              ...
              <div className="w-full md:w-1/2 lg:w-1/3">
                <div className="pt-10 px-6 xs:px-10 pb-14 md:bg-gray-800/60 lg:bg-transparent rounded-r-xl lg:rounded-none">
                  <div className="flex items-center justify-between mb-8 pb-8 border-b border-gray-700">
                    <div>
                      <span className="block text-base font-semibold text-white">
                        Julian Figueroa
              ...
              <div className="w-full md:w-1/2 lg:w-1/3">
                <div className="pt-10 px-6 xs:px-10 pb-14 bg-gray-800/60 rounded-b-xl md:rounded-r-none md:rounded-bl-xl lg:rounded-b-xl">
                  <div className="flex items-center justify-between mb-8 pb-8 border-b border-gray-700">
                    <div>
                      <span className="block text-base font-semibold text-white">
                        Jono Catliff
